...
$(document).ready(function() {
    ...
    if($(".signin").length) {
        $(".signin").validate({
            ...
            messages: {
                username: {
                    required: "username is require<br/>"
                },
                firstname: {
                    required: "firstname is require<br/>"
                },
                lastname: {
                    required: "lastname is require<br/>"
                },
                email: {
                    required: "email is require<br/>"
                },
                password: {
                    required: "password is require"
                },
...
//     $("#btn-signin").removeClass("btn-signin");
...
// $("#btn-sigin").click(function() {
//     $("#btn-sigin").addClass("btn-signin");
